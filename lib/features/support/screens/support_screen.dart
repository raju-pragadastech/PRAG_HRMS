        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text('📧 Email: support@company.com'),
              const Text('📞 Phone: +1 (555) 123-4567'),
              const Text('💬 Chat: Available 9 AM - 6 PM'),
              ...
              const Text('• Critical Issues: Within 2 hours'),
              const Text('• General Support: Within 24 hours'),
            ],
          ),
          actions: [
            TextButton(
